...
gettingStarted: "Install on Kali Linux with `sudo apt install commix`. See the official Kali tool page and upstream homepage linked above for full usage and configuration details."
---
