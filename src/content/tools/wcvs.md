...
gettingStarted: "Install on BlackArch with `pacman -S wcvs` (or add the BlackArch repository to an existing Arch Linux install). See the official BlackArch tool listing linked above for details."
---
